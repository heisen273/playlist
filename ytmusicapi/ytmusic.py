...
from ytmusicapi.model.Config import Config
...
class YTMusic(BrowsingMixin, SearchMixin, WatchMixin, ExploreMixin, LibraryMixin, PlaylistsMixin,
    ...
    def __init__(self,
        ...
        """
        self.auth = auth
        self.config: Config = Config(configFileName)
    ...
    def _loadConfig(self, fileName) -> Config:
        """Docstring for _loadConfig"""
        return parse_obj_as(Config, load_headers_file(fileName))
